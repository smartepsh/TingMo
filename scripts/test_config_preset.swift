...
struct ConfigPresetTests {
    static func main() {
        ...
        assert(defaultPreset.outputLanguage == ConfigPreset.rawOutputLanguage, "default preset should use raw output language")
        ...
        assert(preset.outputLanguage == "en", "preset should store output language")
        ...
        assert(reloaded.defaultPreset.outputLanguage == "en", "store should persist output language")
